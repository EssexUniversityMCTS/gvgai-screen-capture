...
public class ArcadeMachine
{
  ...
  //  	System.out.println(" ** Playing game " + game_file + ", level " + level_file + " **");
    ...
    public static double runLearningGame(String game_file, String level_file, AbstractPlayer player, Game toPlay,
    		boolean visuals, int randomSeed, boolean isHuman, boolean isLearningFinish)
    {
    	VGDLFactory.GetInstance().init(); //This always first thing to do.
    	VGDLRegistry.GetInstance().init();
